...
if __name__ == "__main__":
        ...
        if global_step > args.learning_starts:
            if global_step % args.train_frequency == 0:
                ...
                with torch.no_grad():
                    ...
                    target_max, _ = bootstrap_network(data.next_observations).max(dim=1)
    ...
    if args.save_model:
        ...
        if args.upload_model:
            ...
            push_to_hub(args, episodic_returns, repo_id, "DuelQL", f"runs/{run_name}", f"videos/{run_name}-eval")
