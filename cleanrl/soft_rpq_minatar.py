...
class QNetwork(nn.Module):
    def __init__(self, env):
        ...
        # print(f"Observation space shape: {env.single_observation_space.shape[-1]}")
        # print(f"Observation space shape: {env.single_observation_space.shape}")
        ...
        self.advantage_head = nn.Linear(128, env.single_action_space.n)
